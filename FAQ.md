...
The easiest way is to subscribe to P2P [events](https://novage.github.io/p2p-media-loader/docs/v3.0/types/p2p-media-loader-core.CoreEventMap.html) and log them:
